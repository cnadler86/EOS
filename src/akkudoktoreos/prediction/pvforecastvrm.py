...
class PVForecastVrmCommonSettings(SettingsBaseModel):
    ...
    pvforecast_vrm_token: Optional[str] = Field(
        default=None,
        json_schema_extra={
    ...
    pvforecast_vrm_idsite: Optional[int] = Field(
        default=None,
...
class PVForecastVrm(PVForecastProvider):
    ...
    def _request_forecast(
        self, start_ts: int, end_ts: int, id_site: int, api_token: str
    ) -> VrmForecastResponse:
    ...
    def _update_data(self, force_update: Optional[bool] = False) -> None:
        ...
        vrm_settings = self.config.pvforecast.provider_settings.PVForecastVrm
        id_site = vrm_settings.pvforecast_vrm_idsite
        api_token = vrm_settings.pvforecast_vrm_token
        ...
        vrm_forecast_data = self._request_forecast(start_ts, end_ts, id_site, api_token)
